...
typedef struct{
	...
	unsigned short inversion_m;	
	unsigned short inversion_h;
	unsigned short set_l;
	unsigned short set_m;	
	unsigned short set_h;
	unsigned short step1_low_l;
	unsigned short step1_low_h;
	unsigned short step2_high_l;
	unsigned short step2_high_h;
	unsigned short step3_low_l;
	unsigned short step3_low_h;
	unsigned short step4_high_l;
	unsigned short step4_high_h;	
...
#define PG_BASE			(FPGA_BASE_ADDR_1 + 50)
...
#define OUTPUT_DELAY_DEFAULT	(unsigned int)98//239 // 1=100ns, 1CLK
