...
#define QPI_IO0_HIGH				*R_P5oHIGH = (1<<3)
#define QPI_IO1_HIGH				*R_P5oHIGH = (1<<4)
#define QPI_IO2_HIGH				*R_P5oHIGH = (1<<1)
#define QPI_IO3_HIGH				*R_P5oHIGH = (1<<0)

#define QPI_IO0_LOW				*R_P5oLOW = (1<<3)
#define QPI_IO1_LOW				*R_P5oLOW = (1<<4)
#define QPI_IO2_LOW				*R_P5oLOW = (1<<1)
#define QPI_IO3_LOW				*R_P5oLOW = (1<<0)
